            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              <div className="flex gap-4">
                <div className="w-1/2">
                  ...
                  <Input id="first_name" placeholder="e.g. John" value={formData.first_name} onChange={handleChange} />
                </div>
                <div className="w-1/2">
                  <Label htmlFor="last_name" className="font-normal">
                    Last name
                  </Label>
                  <Input id="last_name" placeholder="e.g. Doe" value={formData.last_name} onChange={handleChange} />
                </div>
              </div>
              ...
              <div>
                ...
                <Input id="organization" placeholder="e.g. Circula" value={formData.organization} onChange={handleChange} />
              </div>

              <div>
                <Label className="font-normal">
                  What commodities do you recycle?
                </Label>
                <MultiSelect
                  options={[
