...
const AreaChart = React.forwardRef<HTMLDivElement, AreaChartProps>((props, ref) => {
  ...
  return (
    <div ref={ref} className={cn('h-80 w-full', className)} tremor-id='tremor-raw' {...other}>
      <ResponsiveContainer>
        <RechartsAreaChart
          data={data}
          onClick={
...
export { AreaChart, type AreaChartEventProps, type TooltipProps as AreaChartTooltipProps };
